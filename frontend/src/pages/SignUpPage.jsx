      ...
      <div className="w-full bg-glass rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <p className="text-gray-300">
            ...
            <span>
              <FaUnlockAlt className="w-4 h-4 inline mx-2 text-teal-400" />
            </span>
          </p>
          <p className="text-base font-light text-emerald-500">
            Already have an account?{" "}
            <Link
              to="/login"
              className="font-medium text-blue-500 hover:underline hover:text-blue-600 pl-2"
            >
              Login
            </Link>
          </p>
